                            ...
                            function(err, token) {
                                if (!err) {
                                    send({ // Overriding default parameters
                                        text: "Hi, recently you requested to reset your password at apply.menlohacks.com." +
                                        " You can do so at this link: localhost:3000?reset_password=" + token + " . " +
                                        ...
                                        "<a href='http://applybeta.menlohacks.com' target='_blank'>apply.menlohacks.com.</a>" +
                                        " You can do so <a href='http://applybeta.menlohacks.com?reset_password=" + token + "'>here</a>." +
            ...
            return new Promise(function(fulfill, reject) {
                authenticate(args.token, function(user) {
                    ...
                    Profile.findById(user.profile).then(function(profile) {
                        ...
                        profile.is_complete = profile.is_complete & profile.mlh_agreement;
                        profile.save(function(err, new_profile) {
                            if (!err) {
                                fulfill(true);
                            } else {
