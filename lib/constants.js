...
const CONSTANTS = {
    ...
    MENLO_FORM_URL: 'https://d2b6s0dsvfyqsi.cloudfront.net/menlo_liability.pdf',
    NON_MENLO_FORM_URL: 'https://d2b6s0dsvfyqsi.cloudfront.net/liability_non_menlo.pdf',
    PHOTO_FORM_URL: 'https://d2b6s0dsvfyqsi.cloudfront.net/photo_release.pdf',
    APPLICATIONS_CLOSE: new Date(2018, 1, 15, 0, 0, 0, 0),
    DISABLED_AFTER_APPLICATIONS_CLOSE: ["cool_project", "last_summer", "school", "is_bgc"],
    DECISIONS_RELEASED: new Date(2018, 1, 15, 0, 0, 0, 0),
