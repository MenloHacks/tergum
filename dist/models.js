...
exports.Application = exports.Profile = exports.User = undefined;
...
var userSchema = new Schema({
    email: {
        ...
        index: { unique: true },
        match: [_constants.CONSTANTS.EMAIL_REGEX, "Please provide a valid email."],
        unique: true
    },
...
var profileSchema = new Schema({
    ...
    grade: {
        type: Number,
        max: [_constants.CONSTANTS.MAX_GRADE, "Only high school students may attend."]
    },
    phone_number: {
        type: String,
        match: [_constants.CONSTANTS.PHONE_REGEX, "Please enter a valid phone number."]
    },
    dietary_restrictions: String,
    shirt_size: {
        type: String,
        enum: {
            values: _constants.CONSTANTS.SHIRT_OPTIONS,
