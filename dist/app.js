...
app.use(function (req, res, next) {
  res.header("Access-Control-Allow-Origin", "https://apply.menlohacks.com"); // update to match the domain you will make the request from
...
app.use(require('forest-express-mongoose').init({
  ...
  authSecret: process.env.FOREST_AUTH_SECRET, //should we add access-control-allow-origin??
