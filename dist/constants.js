...
var CONSTANTS = {
    REQUIRED_PROFILE_FIELDS: ["first_name", "last_name", "school", "grade", "phone_number", "gender", "race_ethnicity", "shirt_size"],
    MAX_GRADE: 12,
    ZIP_REGEX: /^\d{5}(-\d{4})?$/,
    ...
    SHIRT_OPTIONS: ["S", "M", "L", "XL"],
    SCHOOLS: JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'school_names.json'), 'utf8')),
    DIETARY_RESTRICTIONS: ["vegetarian", "vegan", "gluten free", "nut allergy"],
    RACE_ETHNICITY_OPTIONS: ["American Indian or Alaskan Native", "Asian / Pacific Islander", "Black or African American", "Hispanic", "White / Caucasian", "Prefer not to answer"],
